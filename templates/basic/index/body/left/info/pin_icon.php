<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     viewBox="0 0 485.632 485.632" width="32px" height="32px" style="enable-background:new 0 0 485.632 485.632;" xml:space="preserve">
<g>
    <g>
        <g>
            <path style="fill: white;" d="M242.816,0C148.699,0,72.396,76.303,72.396,170.419c0,7.205,0.578,14.227,1.459,21.188
